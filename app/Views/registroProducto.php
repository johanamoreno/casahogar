...
<head>
  ...
  <br>
    ...
    <button type="submit" class="btn btn-secondary col-4">Registrar Producto</button>
    <a class="btn btn-secondary col-4" href="<?= site_url('/productos/listado') ?>">Ver Inventario</a>
